...
public class DescriptorHandler extends MeshHandler {
	private static final Log logger = LogFactory
			.getLog(DescriptorHandler.class);
	...
	public DescriptorHandler(final XMLReader parser, final DefaultHandler parent) {
		super(parser, parent);
	}
	...
	public void startElement(final String uri, final String localName,
		...
		if (qName.equals("Concept")) {
			...
			String preferredConceptYN = attributes
					.getValue("PreferredConceptYN");
			...
			RelatedDescriptorHandler handler = new RelatedDescriptorHandler(
					parser, this);
			childHandler = handler;
			parser.setContentHandler(handler);
	...
	public void endElement(final String uri, final String localName,
		...
		if (qName.equals("ConceptUI")) {
			...
			if (childHandler != null) {
				relatedDescriptors = ((RelatedDescriptorHandler) childHandler)
						.getDescriptorIds();
			}
