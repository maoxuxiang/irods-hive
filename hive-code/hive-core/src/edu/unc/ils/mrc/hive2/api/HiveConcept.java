...
/**
 * This class represents a HIVE Concept. HIVE concepts are simplified versions
 * of SKOS concepts.
 * 
 * @author cwillis
 * 
...
public class HiveConcept {
	 ...
	 * @param c
	 */
	public HiveConcept(final Concept c) {
		qname = c.getQName();
		prefLabel = c.getSkosPrefLabel();
		...
		/*
		 * c.getRdfsComment(); c.getRdfsIsDefinedBy(); c.getRdfsLabel();
		 * c.getRdfsMembers(); c.getRdfsSeeAlso(); c.getRdfTypes();
		 * c.getRdfValues(); c.getSkosAltSymbols(); c.getSkosChangeNotes();
		 * c.getSkosDefinitions(); c.getSkosEditorialNotes();
		 * c.getSkosExamples(); c.getSkosHiddenLabels();
		 * c.getSkosHistoryNotes(); c.getSkosInSchemes();
		 * c.getSkosIsPrimarySubjectOfs(); c.getSkosIsSubjectOfs();
		 * c.getSkosNotes(); c.getSkosPrefSymbols(); c.getSkosPrimarySubjects();
		 * c.getSkosScopeNotes(); c.getSkosSemanticRelations();
		 * c.getSkosSubjectIndicators(); c.getSkosSubjects();
		 * c.getSkosSymbols();
		 */
	}
	 ...
	 */
	public void setBroaderConcepts(final List<String> broaderConcepts) {
	 ...
	 */
	public void setNarrowerConcepts(final List<String> narrowerConcepts) {
	 ...
	 */
	public void setRelatedConcepts(final List<String> relatedConcepts) {
	 ...
	 * @param scopeNotes
	 */
	public void setScopeNotes(final List<String> scopeNotes) {
	 ...
	 * @param uri
	 */
	public void addBroaderConcept(final String uri) {
		broaderConcepts.add(uri);
	}
	 ...
	 * @param uri
	 */
	public void addNarrowerConcept(final String uri) {
		narrowerConcepts.add(uri);
	}
	 ...
	 * @param uri
	 */
	public void addRelatedConcept(final String uri) {
		relatedConcepts.add(uri);
	}
	 ...
	 * @param note
	 */
	public void addScopeNote(final String note) {
		scopeNotes.add(note);
	}
	 ...
	 * @param isTopConcept
	 */
	public void setTopConcept(final boolean isTopConcept) {
